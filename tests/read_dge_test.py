...
class ReadDgeTest(unittest.TestCase):
    def test_valid_read_dge(self):
        file_path = os.path.normpath(os.path.join(os.getcwd(), "../test_fixtures/golden/read_dge_counts_breast.csv"))
        ...
        pd.testing.assert_frame_equal(golden, dge, check_dtype=False, check_like=True)
